...
with gr.Blocks() as demo:
    ...
    gr.Markdown(
        "This app loads the trained YOLO model, predicts on a new image, draws boxes, "
        "and shows a simple table of detected species and confidence scores."
    )
    ...
    with gr.Tab("Model Evaluation Plots"):
        gr.Markdown(
            "These are the saved evaluation plots from training. "
            "They help explain model performance in a simple way."
        )
        gallery = gr.Gallery(
